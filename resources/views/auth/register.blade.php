...
@section('content')
    ...
    >
        ...
        <div class="field mb-6">
            <label class="label text-sm text-default mb-2 block" for="name">Name</label>
        ...
        <div class="field mb-6">
            <label class="label text-sm text-default mb-2 block" for="email">Email Address</label>
        ...
        <div class="field mb-6">
            <label class="label text-sm text-default mb-2 block" for="password">Password</label>
        ...
        <div class="field mb-6">
            <label class="label text-sm text-default mb-2 block" for="password-confirmation">Confirm Password</label>
