    ...
    <div class="flex">
        <div class="flex-1 mr-4">
            <div class="mb-4">
                ...
                <input type="text" name="title" class="border border-muted-light p-2 text-xs block w-full rounded">
            </div>

            <div class="mb-4">
                <label for="description" class="text-sm block mb-2">Title</label>
                <textarea name="description" class="border border-muted-light p-2 text-xs block w-full rounded" rows="7"></textarea>
            </div>
        </div>
        <div class="flex-1 ml-4">
            <div class="mb-4">
                <label for="tasks" class="text-sm block mb-2">Need some task</label>
                <input type="text" name="task" class="border border-muted-light p-2 text-xs block w-full rounded" placeholder="Task 1">
            </div>
